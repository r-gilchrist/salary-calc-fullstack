...
class TestStudentLoanModel(TestCaseWithDate):
    ...
    def test_plan_1(self):
        student_loan = StudentLoan(gross_salary=30000, loan_type="plan_1", date=self.date)
        self.assertAlmostEqual(876, student_loan.get_amount())

    def test_plan_2(self):
        student_loan = StudentLoan(gross_salary=30000, loan_type="plan_2", date=self.date)
