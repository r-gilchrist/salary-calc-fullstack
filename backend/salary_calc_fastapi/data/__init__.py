...
def _get_value(value_type: str, tax_type: str, category: str, date: Date) -> int:
...
def get_rate(tax_type: str, category: str, date: Date) -> int:
    return _get_value("rate", tax_type, category, date)


def get_threshold(tax_type: str, category: str, date: Date) -> int:
